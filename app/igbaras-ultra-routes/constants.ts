...
export const viewStateMobile = {
  initial: {
    center: new mapboxgl.LngLat(122.21107416260037, 10.781527996457342),
  ...
  imu10: {
    ...
    center: new mapboxgl.LngLat(122.25249862129169, 10.716028585212769),
  },
  imu21: {
    ...
    center: new mapboxgl.LngLat(122.23667562269958, 10.728241004860607),
  },
  imu50: {
    center: new mapboxgl.LngLat(122.2266510331844, 10.755530058978621),
    zoom: 11.967043298619616,
    pitch: 0.5000000000000002,
    bearing: -51.89779285056272,
  },
  imu80: {
    center: new mapboxgl.LngLat(122.21851076330023, 10.763579411585496),
